...
import com.cbsb.textedit.R.string;
...
public class pmTextEdit extends Activity
{
	...
	private final static int MENU_OPTIONS_ID = Menu.FIRST + 1;
	private final static int MENU_OPEN_ID = Menu.FIRST + 2;
	private final static int MENU_NEW_ID = Menu.FIRST + 3;
	private final static int MENU_OPENRECENT_ID = Menu.FIRST + 4;
	private final static int MENU_SAVEAS_ID = Menu.FIRST + 5;
	...
	private static final int IDM_About = Menu.FIRST + 9;
	...
	protected void updateOptions()
	{
		...
		/********************************
		 * Colors */
		int bgcolor = sharedPref.getInt("bgcolor", R.color.White);
		text.setBackgroundColor(bgcolor);
		
		int fontcolor = sharedPref.getInt("fontcolor", R.color.Black);
...
//							if (!openingRecent)
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		menu.add(0, MENU_NEW_ID, 0, R.string.menu_new_file).setShortcut('0', 'n').setIcon(R.drawable.ic_menu_compose);
		menu.add(0, MENU_SAVE_ID, 0, R.string.menu_save).setShortcut('0', 's').setIcon(R.drawable.ic_menu_save);
		menu.add(0, MENU_SAVEAS_ID, 0, R.string.menu_save_as).setIcon(R.drawable.ic_menu_set_as);		
		menu.add(0, MENU_OPTIONS_ID, 0, string.options).setIcon(R.drawable.ic_menu_preferences);
		menu.add(0, MENU_OPEN_ID, 0, R.string.menu_Open).setShortcut('0', 'o').setIcon(R.drawable.ic_menu_archive);
		menu.add(0, MENU_EMAIL, 0, R.string.menu_Email_Text).setShortcut('0', 'e');
		menu.add(0, MENU_SEARCH, 0, R.string.menu_Search_Text).setShortcut('0', 'f');
		menu.add(0, MENU_ATTACHMENT, 0, R.string.menu_Email_as_Attachment).setIcon(R.drawable.ic_menu_send);
		menu.add(0, MENU_OPENRECENT_ID, 0, R.string.menu_Recent).setShortcut('0', 'r').setIcon(R.drawable.ic_menu_view);
		menu.add(0, IDM_About, 0, string.about).setIcon(R.drawable.ic_menu_info_details);
		return true;
