...
public class FileBrowser extends Activity
{
	...
	protected void onPrepareDialog(int id, Dialog dialog)
	{
		switch (id) {
			...
			case DIALOG_SHOULD_DELETE: {
				dialog.setTitle(R.string.confirm_del + dialog_file.getName());
				break;
			}
			case DIALOG_RENAME: {
	...
	protected Dialog onCreateDialog(int id)
	{
		switch (id) {
			...
			case DIALOG_SHOULD_DELETE: {
				return new AlertDialog.Builder(this)
				.setTitle(R.string.confirm_del + dialog_file.getName())
			...
			case DIALOG_COULDNT_DELETE: {
				...
				.setMessage(R.string.error_del_file)
			...
			case DIALOG_COULDNT_DELETEDIR: {
				return new AlertDialog.Builder(this)
				.setTitle(R.string.Error)
				.setMessage(R.string.error_del_dir)
				.setPositiveButton(R.string.Continue, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
			...
			case DIALOG_COULDNT_RENAME: {
				return new AlertDialog.Builder(this)
				.setTitle(R.string.Error)
				.setMessage(R.string.error_ren_file)
				.setPositiveButton(R.string.Continue, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		menu.add(0, MENU_MKDIR, 0, R.string.create_dir).setShortcut('0', 'c').setIcon(android.R.drawable.ic_menu_add);
